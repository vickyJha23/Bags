...
const ErrorPage = () => {
    ...
    return (
        <main class="grid min-h-screen place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8 dark:bg-[#111] dark:text-white">
            <div class="text-center">
                <p class="text-base font-semibold text-indigo-600">404</p>
                <h1 class="mt-4 text-balance text-5xl font-semibold tracking-tight text-gray-900 dark:text-white  sm:text-7xl">{error.statusText || error.message}</h1>
